    ...
    <AdminPageShell
      ...
      actions={
        <>
          <Button 
            variant="outline" 
            className="border-surface-border bg-transparent"
            onClick={() => toast.success('Vault ledger export started')}
          >
            Export vault ledger
          </Button>
          <Button 
            className="bg-brand-primary text-[#031018] hover:brightness-110"
            onClick={() => toast.success('Rebalance queued for next execution window')}
          >
            Queue rebalance
          </Button>
        </>
